# Generated by Django 3.2 on 2021-12-09 19:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang', models.CharField(choices=[(None, 'Выберите язык'), ('Ru', 'Русский'), ('Kg', 'Кыргызский')], default='Ru', max_length=15, verbose_name='Язык')),
                ...
                ('project', models.BooleanField(default=False, help_text='Эта запись является Проектом', verbose_name='Проект')),
