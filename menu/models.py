...
class MenuLink(models.Model):
	...
	lang_menu_link = models.CharField(max_length=15, choices=LANGUAGE_CHOICES, default='Ru')
...
class FooterLink(models.Model):
	...
	is_active = models.BooleanField(default=False)
	link = models.URLField(max_length=200)
	lang_footer_link = models.CharField(max_length=15, choices=LANGUAGE_CHOICES, default='Ru')
