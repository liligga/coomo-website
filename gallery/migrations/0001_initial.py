# Generated by Django 3.2 on 2021-11-03 12:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery_id', models.ForeignKey(help_text='Выберите к какой галлереи будет приндлажать картинка', on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='gallery.gallery', verbose_name='Имя галлереи')),
            ],
            options={
